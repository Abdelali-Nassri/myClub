...
<div class="row">
	<div class="col-sm-2 bg-success">
		...
		<form class="form-inline border-bottom border-dange" action="GerantDash" method="post">
			<input type="hidden" name="btn" value="seaEq">
			<button class="btn btn-outline-light btn-lg btn-block mb-4 mt-4 ml-2 mr-2" type="submit"><i class="fas fa-search"></i> Tiki</button>		
		</form>
	</div>
	<div class="col-sm-10">
		<br>
		...
		<div class="col-sm-7 bg-white ml-4">
			...
			<div class="row m-4"><div class="col-sm-4">Confirmer</div><%if(((Adherent)session.getAttribute("profil")).isConfirmer()){ %><div class="col-sm-4 btn btn-outline-success disabled"><%;}else{ %><div class="col-sm-4 btn btn-danger disabled"><%;} %><c:out value="${profil.isConfirmer()}"></c:out></div></div>
